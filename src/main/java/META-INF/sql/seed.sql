...
INSERT IGNORE INTO tasks (id, idUser, title, description, status, dtLimit, dtComplete, idLista) VALUES (1, 1, "Fazer Compras", "Ir ao mercado mais perto", 0, null, null, null)
